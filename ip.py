...
while True:
    ...
    texto_formatado1 = fonte.render(mensagem_azul, False, (255, 255, 255))
    texto_formatado2 = fonte.render(mensagem_laranja, False, (255, 255, 255))
    texto_formatado3 = fonte.render(mensagem_roxo, False, (255, 255, 255))
